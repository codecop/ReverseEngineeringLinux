...
0000000000001289 <main>:
    ...
    1303:	48 89 45 e8          	mov    QWORD PTR [rbp-0x18_flag],rax
    1307:	48 8b 75 e0          	mov    rsi,QWORD PTR [rbp-0x20]
    130b:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28]
    130f:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18_flag]
    ...
    1334:	e8 07 fe ff ff       	call   1140 <time@plt>                  // call c function time returns time
    1339:	89 45 c8             	mov    DWORD PTR [rbp-0x38_time],eax    // speichere Zeit in -38
    133c:	8b 45 c8             	mov    eax,DWORD PTR [rbp-0x38_time]
    ...
    135c:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18_flag]
    ...
    1372:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18_flag]
    ...
    138b:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18_flag]
    ...
    139c:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18_flag]
    ...
    13e5:	48 8d 45 c8          	lea    rax,[rbp-0x38_time]
    ...
    1406:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18_flag]
